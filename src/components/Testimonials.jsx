...
const Testimonials = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from those who find home with Us</p>
        ...
        {testimonialsData.map((testimonials , index)=>(
            <div key={index} className='max-w-[300px]  border shadow-lg rounded px-8 py-12 text-center'>
                <img className='w-20 h-20 rounded-full mx-auto mb-4'
                 src={testimonials.image} alt={testimonials.alt} />
                 ...
                 <p className='test-gray-600'> {testimonials.text} </p>
            </div>
        ))}
    </div>
    </motion.div>
